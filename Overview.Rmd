...
topic <- c("Introduction and overview", 
           ...
           "Tree-based models and cluster analysis",  
           "Recap and student presentations")
reading <- c("ECP",
             "LADAL: Introduction to Quantitative Reasoning", 
             "LADAL: Basic Concepts in Science",
             "LADAL: Getting started with R",
             "LADAL: Working with tables",
             "LADAL: Data Visualization with R",
             "LADAL: Descriptive statistics",
             "LADAL: Regression Analysis",
             "LADAL: Regression Analysis",
             "LADAL: Regression Analysis",
             "LADAL: Regression Analysis",
             "LADAL: Tree-based models / Cluster Analsis",
             "")
url <- c("",
